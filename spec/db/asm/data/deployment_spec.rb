...
describe ASM::Data::Deployment do
  ...
  before do
    config = ASM::Config.new(YAML.load_file(ASM.test_config_file))
    ...
    @deployment_data = SpecHelper.json_fixture("deployments/ff808081452c813b01453c4b14e80751/deployment.json")
  end
