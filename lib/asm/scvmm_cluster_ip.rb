...
result = winrm.powershell("Import-Module VirtualMachineManager;  Get-VMMServer -ComputerName localhost; Get-SCVMHostCluster | Where-Object -Property Name -Like #{@opts[:cluster]}.* | Select -ExpandProperty IPAddresses | Select IPAddressToString")
